...
//TODO add AppenderNameCodcompletion Context
    ...
    public class L4NCodeCompletionContext : XmlCodeCompletionContextBase<IXmlFile>
    {
        ...
        public L4NCodeCompletionContext(ISolution solution, ITextControl textControl) : base(solution, textControl)
        {
        ...
        public IList<ILookupItem> EvaluateLookupItems()
        {
            ...
            IList<ILookupItem> filteredList = LookupUtil.GetFilteredItems(result, GetPrefix(), CodeCompletionSettings.Instance.CaseSensitiveCompletion.Value);
            return filteredList;
        }
