...
namespace Arp.NH.Psi.Tree.Impl
{
    public partial class MapElementImpl : XmlTag,  IMapElement
    {
        ...
        private const int CompositeIndex_ROLE_ID = 6;

        private const int IndexManyToMany_ROLE_ID = 7;

        private const int IndexManyToAny_ROLE_ID = 8;

        private const int Element_ROLE_ID = 9;

        private const int OneToMany_ROLE_ID = 10;

        private const int ManyToMany_ROLE_ID = 11;

        private const int CompositeElement_ROLE_ID = 12;

        private const int ManyToAny_ROLE_ID = 13;

        private const int Filter_ROLE_ID = 14;

        private const int Loader_ROLE_ID = 15;

        private const int SqlInsert_ROLE_ID = 16;

        private const int SqlUpdate_ROLE_ID = 17;

        private const int SqlDelete_ROLE_ID = 18;

        private const int SqlDeleteAll_ROLE_ID = 19;
