...
namespace Arp.NH.Psi.Tree.Impl
{
    public partial class SubclassElementImpl : XmlTag,  ISubclassElement
    {
        ...
        private const int Idbags_ROLE_ID = 12;

        private const int Arrays_ROLE_ID = 13;

        private const int PrimitiveArrays_ROLE_ID = 14;

        private const int Subclass_ROLE_ID = 15;

        private const int Loader_ROLE_ID = 16;

        private const int SqlInsert_ROLE_ID = 17;

        private const int SqlUpdate_ROLE_ID = 18;

        private const int SqlDelete_ROLE_ID = 19;
